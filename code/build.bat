...
set CommonCompilerDebugFlags=/MT /O2 /Oi /fp:fast /fp:except- /Zo /Gm- /GR- /EHa /WX /W4 %UntreatedWarnings% /Z7 /nologo /I %SDLPath%\include\
...
pushd ..\build\
cl %CommonCompilerDebugFlags% ..\code\cursed.cpp /link %CommonLinkerDebugFlags%
popd
